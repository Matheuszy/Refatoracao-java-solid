...
import br.com.alura.config.Mapper;
...
public class PetService {
    ...
    public void listarPetsDoAbrigo() throws IOException, InterruptedException {
        ...
        Pet[] pets = mapper.mapear(responseBody, Pet[].class);
    ...
    public void importarPetsDoAbrigo() throws IOException, InterruptedException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            Pet novo_pet = new Pet(tipo, nome, raca, idade, cor, peso);

            String uri = "http://localhost:8080/abrigos/" + idOuNome + "/pets";
            HttpResponse<String> response = client.dispararRequisicaoPost(uri, novo_pet);
            int statusCode = response.statusCode();
            String responseBody = response.body();
            if (statusCode == 200) {
